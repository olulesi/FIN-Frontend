...
//RIN
import rindo from '../audio/homonyms/rin/rindo.mp3'
import rinre from '../audio/homonyms/rin/rinre.mp3'
import erindomi from '../audio/homonyms/rin/erindomi.mp3'
...
export const gameData = [
  ...
  // NAMES
  {
    word: "Móládé",
    audioFile: Molade,
    options: ["Re Do Re Do", "Mi Mi Mi", "Re Mi Mi Do", "Do Mi Do Do"],
    correct: 1,
    category: "Name",
    sentence: "Mo nílò láti sọ 'mọ́rọ̀wọ́rẹ̀' ní ọ̀nà tó tọ́.",
    translation: "I need to pronounce 'morowore' correctly.",
  },
  {
    word: "Shólá",
    audioFile: shola,
    options: ["Re Do", "Mi Mi", "Re Mi ", "Do Mi "],
    correct: 1,
    category: "Name",
    sentence: "Mo nílò láti sọ 'mọ́rọ̀wọ́rẹ̀' ní ọ̀nà tó tọ́.",
    translation: "I need to pronounce 'morowore' correctly.",
  ...
  },
  {
    word: "rín",
    audioFile: erindomi,
    imageFile: erinLaughImg,
    tonePattern: ["Do", "Mi"],
    options: ["Re Mi", "Do Mi", "Re Re", "Do Re"],
    correct: 1,
    category: "homonyns",
    sentence: "",
    translation: "",
