...
const YorubaUseCasesCarousel = () => {
  ...
  const videos = [
    {
      src: 'https://fin-assets.s3.eu-west-1.amazonaws.com/yoruba-usecase-videos/yorubaUseCase1.mp4',
      keywords: ['comedy', 'dialogue'],
    },
    {
      src: 'https://fin-assets.s3.eu-west-1.amazonaws.com/yoruba-usecase-videos/yorubaUseCase2.mp4',
      keywords: ['comedy', 'dialogue'],
    },
    {
      src: 'https://fin-assets.s3.eu-west-1.amazonaws.com/yoruba-usecase-videos/yorubaUseCase3.mp4',
      keywords: ['comedy', 'dialogue'],
    },
    {
      src: 'https://fin-assets.s3.eu-west-1.amazonaws.com/yoruba-usecase-videos/yorubaUseCase4.mp4',
      keywords: ['comedy', 'dialogue'],
    },
    {
      src: 'https://fin-assets.s3.eu-west-1.amazonaws.com/yoruba-usecase-videos/yorubaUseCase5.mp4',
      keywords: ['comedy', 'dialogue'],
    },
    {
      src: 'https://fin-assets.s3.eu-west-1.amazonaws.com/yoruba-usecase-videos/yorubaUseCase6.mp4',
      keywords: ['comedy', 'dialogue'],
    },
    {
      src: 'https://fin-assets.s3.eu-west-1.amazonaws.com/yoruba-usecase-videos/yorubaUseCase7.mp4',
      keywords: ['comedy', 'dialogue'],
    },
  ]
    ...
    <section className="yoruba-use-cases">
      ...
      <div className="carousel-container">
        ...
        <div className="video-wrapper">
          <video ref={videoRef} src={currentVideo.src} controls></video>
        </div>
